...
public class HurtMePlentyPageTest {
    ...
    public void openNewBrowser() {
        ...
        hurtMePlentyPage.openPage()
                ...
                .choseInstanceType("n1-standard-8 (vCPUs: 8, RAM: 30GB)")
                .choseGRUs("1", "NVIDIA Tesla V100")
    ...
    public void testTotalCost(){
        ...
        Assert.assertEquals(hurtMePlentyPage.getEstimatedComponentCostValue(), "Total Estimated Cost: USD 1,085.25 per 1 month");
    }
