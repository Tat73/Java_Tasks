...
public class HardCorePage extends InitNewDriver {
    ...
    public HardCorePage openCalculatorPage() {
        driver.get(HOMEPAGE_URL);
        waitForPageLoad();
        return this;
    }

    public HardCorePage inputSearchText(String text) {
    ...
    public HardCorePage searchElement() {
        waitForPageLoad();
    ...
    public HardCorePage clickOnComputeEngine() {
        wait.until(ExpectedConditions.elementToBeClickable(clickOnComputeEngine)).click();

        return this;
    }

    public HardCorePage inputNumberOfInstances(String number) {
    ...
    public HardCorePage choseSoftware(String software) {
    ...
    public HardCorePage choseMachineClass(String machineClass) {
    ...
    public HardCorePage choseSeriesOfInstanceType(String seriesOfInstanceType) {
    ...
    public HardCorePage choseInstanceType(String instanceType) {
    ...
    public HardCorePage choseGPUButton() {
    ...
    public HardCorePage choseGRUsType(String inputGRUsType) {
    ...
    public HardCorePage choseGRUsNumber(String GPUsNumber) {
    ...
    public HardCorePage inputLocalSSD(String SSD) {
    ...
    public HardCorePage choseDatacenterLocation(String location) {
    ...
    public HardCorePage choseCommitedUsage(String usage) {
    ...
    public HardCorePage addToEstimateButton() {
        wait.until(ExpectedConditions.elementToBeClickable(clickOnButton)).click();

        return new HardCorePage(driver);
    }

    public HardCorePage clickOnEmailButton() {
    ...
    public HardCorePage generateRandomEmail() {
    ...
    public HardCorePage copyEmail() {
        wait.until(ExpectedConditions.elementToBeClickable(copyNewEmail)).click();
        return this;
    }

    public HardCorePage inputEmailToCalculator(String email) {
